function [destX, destY] = mission_plan(event_map, currX, currY, rotationZ, taskNum)
...
%robot.
    ...
    % Distance for Preliminary Task (Case 0)
    DISTANCE = 30;
    
    % Heading for Task 6 (Case 6)
    OFFSET = 15;        % Number of degrees to turn
    
    switch taskNum
        case 0
            destX = DISTANCE*cos(rotationZ)+currX;
            destY = DISTANCE*sin(rotationZ)+currY;
            
        case 1    % Spiral Search Pattern Parameters
