...
#define MAGN_X_MIN ((float) -589)
#define MAGN_X_MAX ((float) 588)
#define MAGN_Y_MIN ((float) -590)
#define MAGN_Y_MAX ((float) 596)
#define MAGN_Z_MIN ((float) -601)
#define MAGN_Z_MAX ((float) 598)
...
#define GYRO_AVERAGE_OFFSET_X ((float) -33.90)
#define GYRO_AVERAGE_OFFSET_Y ((float) 6.39)
#define GYRO_AVERAGE_OFFSET_Z ((float) 3.90)
